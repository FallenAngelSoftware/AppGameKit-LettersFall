...
function DisplayTitleScreen( )
	if ScreenFadeStatus = FadingFromBlack and ScreenFadeTransparency = 255
		...
		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, GameVersion, 999, 16, 0, 188, 0, 255, 0, 0, 0, 1, ScreenWidth/2, 21-4, 3)
		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, GameVersion, 999, 16, 0, 128, 0, 255, 0, 0, 0, 1, ScreenWidth/2, 21+4, 3)
		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, GameVersion, 999, 16, 0, 255, 0, 255, 0, 0, 0, 1, ScreenWidth/2, 21, 3)

		LF110Logo = CreateSprite ( 35 )
		SetSpriteOffset( LF110Logo, (GetSpriteWidth(LF110Logo)/2) , (GetSpriteHeight(LF110Logo)/2) ) 
		SetSpritePositionByOffset( LF110Logo, ScreenWidth/2, 49+offsetY+33 )
		SetSpriteDepth ( LF110Logo, 3 )
			
		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, "™", 999, 25, 90, 251, 255, 255, 0, 0, 0, 1, ScreenWidth-12, 40, 3)
				
		SetSpritePositionByOffset( ScreenLine[0], ScreenWidth/2, 105+offsetY+13+5+28 )
		SetSpriteColor(ScreenLine[0], 90, 251, 255, 255)

		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, "''"+HighScoreName [ GameMode, 0 ]+"''", 999, 19, 90, 251, 255, 255, 0, 0, 0, 1, ScreenWidth/2, 125+offsetY+13+5+28, 3)
		CreateAndInitializeOutlinedText(TRUE, CurrentMinTextIndex, str(HighScoreScore [ GameMode, 0 ]), 999, 19, 90, 251, 255, 255, 0, 0, 0, 1, ScreenWidth/2, 125+21+offsetY+13+5+28, 3)
...
function SetupAboutScreenTexts( )
	...
	StartIndexOfAboutScreenTexts = CreateAndInitializeOutlinedText(outline, CurrentMinTextIndex, AboutTexts[0], 999, 16, 255, 255, AboutTextsBlue[0], 255, 0, 0, 0, 1, ScreenWidth/2+70, AboutTextsScreenY[0], 3)
	inc startScreenY, 25
...
indexX as integer	
	...
	if (NewLevelTextAlphaDirection <> -1)
		...
		if (NewLevelTextAlphaDirection = 1)
			if (  NewLevelTextAlpha < ( 255-(255/5) )  )
				inc NewLevelTextAlpha, (255/5)
			else
				NewLevelTextAlpha = ( 255-(255/5) )
		...
		elseif (NewLevelTextAlphaDirection = 0)
			if ( NewLevelTextAlpha > (255/5) )
				dec NewLevelTextAlpha, (255/5)
			else
				NewLevelTextAlpha = 0
				NewLevelTextDisplayDelay = 0
				NewLevelTextAlphaDirection = -1
